...
export const QUESTIONS: Question[] = [
  {
    ...
    answers: [
      ...
      { id: 'rag', label: 'Document analysis / RAG pipeline', hint: 'Retrieval, summarisation, citations' },
      { id: 'agent', label: 'Autonomous agent / tool-use', hint: 'Multi-step tasks, function calling' },
      { id: 'creative', label: 'Creative / generative content', hint: 'Writing, images, multimodal' },
    ],
  },
  {
    id: 'latency',
  ...
  },
  {
    ...
    answers: [
      { id: 'open', label: 'Yes — open weights required', hint: 'On-prem, air-gapped, full control' },
