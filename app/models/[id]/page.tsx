...
const BENCHMARK_META: BenchmarkEntry[] = [
  ...
  },
  {
    key: 'humaneval',
    label: 'HumanEval',
    description: 'Code generation pass@1 — 164 Python programming problems',
    maxScore: 100,
  },
  {
    key: 'mt_bench',
    label: 'MT-Bench',
    description: 'Multi-turn conversation quality — GPT-4 judge, scored 1–10',
    maxScore: 10,
  },
];
...
function computeBenchmarkStats(
  ...
  const scores = allModels.map((m) => m.benchmarks[key]).filter((v): v is number => v !== null);
            ...
            <div className="flex flex-wrap items-center gap-3 mb-3">
              ...
              <span
                ...
                style={{
                  ...
                  border: `1px solid ${costTier.color}44`,
                }}
              >
                {costTier.label}
              </span>
            ...
            >
              ...
              <div className="space-y-6">
                {BENCHMARK_META.map((bm) => {
                  ...
                  const pct =
                    score !== null && stats.best !== null ? (score / bm.maxScore) * 100 : 0;
                    ...
                    <div key={bm.key}>
                      <div className="flex items-center justify-between mb-1">
                        <div className="flex items-center gap-2">
                          ...
                          {isFirst && (
                            <span title="Best in class" className="text-base">
                              👑
                            </span>
                          )}
                          {isLast && (
              ...
              >
                ...
                {model.pricing.input === null ? (
                  <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
                    Open weights — pricing depends on your infrastructure.
                  </p>
                ) : (
              ...
              <ul className="space-y-2">
                {model.strengths.map((s, i) => (
                  <li
                    ...
                    style={{ color: 'var(--color-text)' }}
                  >
                    <span className="mt-0.5 shrink-0" style={{ color: 'var(--color-secondary)' }}>
                      ✓
                    </span>
                    {s}
                  </li>
