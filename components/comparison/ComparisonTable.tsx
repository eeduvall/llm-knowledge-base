  ...
  return (
    ...
    >
      <table
        ...
        style={{ minWidth: `${Math.max(600, rows.length * 200)}px` }}
      >
        <thead>
          <tr
            style={{
          ...
          <TableRow label="Release Date">
            {rows.map(({ model }) => (
              <td
                key={model.id}
                className="px-5 py-3"
                style={{ borderLeft: '1px solid var(--color-border)', color: 'var(--color-text)' }}
              >
                {model.release_date}
              </td>
            ))}
              ...
              return (
                <td
                  ...
                  style={{
                    ...
                    ...highlightStyle(h.isBest, h.isWorst, h.value),
                  }}
                >
            ...
            {rows.map(({ model, highlights }) => {
              ...
              return (
                ...
                >
                  ...
                  {h.isBest && model.pricing.input !== null && (
            ...
            {rows.map(({ model, highlights }) => {
              ...
              return (
                ...
                >
                  ...
                  {h.isBest && model.pricing.output !== null && (
                    <span className="ml-1 text-xs">👑</span>
                  )}
                </td>
              );
